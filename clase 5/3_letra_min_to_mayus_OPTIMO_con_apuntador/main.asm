...
; Van a tener una palabra de maximo 6 letras almacenadas en igual cantidad de posiciones de memoria.
; Puede traer minúsuclas y mayúsculas. Leer 0 significa que ahí termina la palabra.
; Convertir todas las letras a mayúsculas.
; la palabra empieza en 0x200
...
start:
	...
	; la palabra empieza en 0x201H
	ldi r27, 0x02		; higher byte X
	ldi r26, 0x00		; lower byte X

verificar_letra:
	inc r26		; incrementar en 1
	cpi r26, 0x06		; comparar con valor inmediato (la palabra llega hasta máximo 6 letras)
	breq end
