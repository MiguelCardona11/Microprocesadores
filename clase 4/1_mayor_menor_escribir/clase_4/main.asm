...
; comparar posiciones de memoria 200H y 201H.
; si 200H > 201H escribir MAYOR en las posiciones 202H-206H
; si 200H < 201H escribir MENOR
; si 200H = 201H escribir IGUAL
